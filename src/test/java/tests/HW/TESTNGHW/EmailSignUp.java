...
public class EmailSignUp {
    ...
    public void testCase6(){
        ...
        driver.get("https://www.tempmailaddress.com/");
//        WebElement ReceivedEmail =driver.findElement(By.xpath("//span[contains(text() ,'practice.cybertek')]"));
...
//          ReceivedEmail.click();
//        String fromEmail = driver.findElement(By.id("[id='odesilatel']")).getText();
